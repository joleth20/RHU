...
if ($user_type != "1") {
  ...
  if($_SESSION["password_req"] != "ON"){
      ...
      echo '<input type="hidden" name="reports_title" value="Patient Reports">';
      echo '<input type="hidden" name="reports_link" value="reports_p">';
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
          <form action="../RHU/?p=reports_p_export" method="post">
        ...
        <div class="table-responsive">
          <table class="table" id="rhu_table">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM user_details WHERE user_type = '4'";
